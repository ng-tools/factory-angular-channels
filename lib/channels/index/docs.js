    ...
    inject(
      merge(
        vfs.src(paths.scripts, {cwd: paths.cwd, base: paths.cwd})
          .pipe(require('./../scripts/src').bind(_.defaults({tmp: path.join(paths.tmp, paths.cwd)}, this))())
          .pipe(gulpif('**/*.js', angularFilesort())),
      vfs.src(paths.styles, {cwd: paths.cwd, base: paths.cwd})
          .pipe(require('./../styles/src').bind(_.defaults({tmp: path.join(paths.tmp, paths.cwd)}, this))())
      ),
